...
export const intro = [
  ...
  { t: ' i work on ' },
  { t: 'models & inference for voice', hl: 'voice' },
...
export const experience = [
  ...
  },
  {
    ...
    points: [
      ...
      'where i learned to make big end-to-end self-driving models go brrr on bigger GPUs: distributed training runs over large public perception, prediction, and planning datasets.',
